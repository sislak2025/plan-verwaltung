        ...
        'fields' => array(
            ...
            array(
                ...
                'sub_fields' => array(
                    ...
                    array(
                        'key' => 'pv_job_entwicklungen',
                        'label' => 'Entwicklungsumgebungen',
                        'name' => 'pv_job_entwicklungen',
                        'type' => 'repeater',
                        'instructions' => '',
                        'required' => 0,
                        'conditional_logic' => 0,
                        ...
                        'sub_fields' => array(
                            array(
                                'key' => 'pv_entwicklung_kunde',
                                'label' => 'Kunde / Bezeichnung',
                                'name' => 'pv_entwicklung_kunde',
                                'type' => 'text',
                                'prefix' => '',
                                'instructions' => '',
                                'required' => 0,
                            ...
                            array(
                                'key' => 'pv_entwicklung_id',
                                'label' => 'Entwicklung Nummer',
                                'name' => 'pv_entwicklung_id',
                                'type' => 'number',
                                'prefix' => '',
                                'instructions' => '',
                                'required' => 0,
                            ...
                            array(
                                'key' => 'pv_accordion_website_daten',
                                'label' => 'Website',
                                'type' => 'accordion',
                                'required' => 0,
                                'conditional_logic' => 0,
                            ...
                            array(
                                'key' => 'pv_entwicklung_url',
                                'label' => 'Entwicklungsdomain',
                                'name' => 'pv_entwicklung_url',
                                'type' => 'url',
                                'prefix' => '',
                                'instructions' => '',
                                'required' => true,
                            ...
                            array(
                                'key' => 'pv_entwicklung_username',
                                'label' => 'Benutzername',
                                'name' => 'pv_entwicklung_username',
                                'type' => 'text',
                                'prefix' => '',
                                'instructions' => '',
                                'required' => 0,
                            ...
                            array(
                                'key' => 'pv_entwicklung_passwort',
                                'label' => 'Passwort',
                                'name' => 'pv_entwicklung_passwort',
                                'type' => 'text',
                                'prefix' => '',
                                'instructions' => '',
                                'required' => 0,
                            ...
                            array(
                                'key' => 'pv_entwicklung_ftp_server',
                                'label' => 'Verbindungsadresse',
                                'name' => 'pv_entwicklung_ftp_server',
                                'type' => 'text',
                                'prefix' => '',
                                'instructions' => '',
                                'required' => 0,
                            ...
                            array(
                                'key' => 'pv_entwicklung_ftp_port',
                                'label' => 'Port',
                                'name' => 'pv_entwicklung_ftp_port',
                                'type' => 'number',
                                'prefix' => '',
                                'instructions' => '',
                                'required' => 0,
                            ...
                            array(
                                'key' => 'pv_entwicklung_ftp_username',
                                'label' => 'Benutzername',
                                'name' => 'pv_entwicklung_ftp_username',
                                'type' => 'text',
                                'prefix' => '',
                                'instructions' => '',
                                'required' => 0,
                            ...
                            array(
                                'key' => 'pv_entwicklung_ftp_passwort',
                                'label' => 'Passwort',
                                'name' => 'pv_entwicklung_ftp_passwort',
                                'type' => 'text',
                                'prefix' => '',
                                'instructions' => '',
                                'required' => 0,
                            ...
                            array(
                                'key' => 'pv_accordion_hosting_daten',
                                'label' => 'Hosting',
                                'type' => 'accordion',
                                'required' => 0,
                                'conditional_logic' => 0,
                            ...
                            array(
                                'key' => 'pv_entwicklung_hosting_hoster',
                                'label' => 'Logindomain (Hoster)',
                                'name' => 'pv_entwicklung_hosting_hoster',
                                'type' => 'url',
                                'prefix' => '',
                                'instructions' => '',
                                'required' => 0,
                            ...
                            array(
                                'key' => 'pv_entwicklung_hosting_username',
                                'label' => 'Benutzername',
                                'name' => 'pv_entwicklung_hosting_username',
                                'type' => 'text',
                                'prefix' => '',
                                'instructions' => '',
                                'required' => 0,
                            ...
                            array(
                                'key' => 'pv_entwicklung_hosting_passwort',
                                'label' => 'Passwort',
                                'name' => 'pv_entwicklung_hosting_passwort',
                                'type' => 'text',
                                'prefix' => '',
                                'instructions' => '',
                                'required' => 0,
                    ...
                    array(
                        'key' => 'pv_accordion_entwicklung_end',
                        'label' => 'Akkordeon Entwicklung Ende',
                        'type' => 'accordion',
                        'required' => 0,
                        'conditional_logic' => 0,
                        'wrapper' => array(
...
function register_passwords_posttype()
{
    $posttype_class = new PV_Posttype();
    ...
    $post_data['post_type'] = array(
        'label' => __($post_slug),
        'description' => __('Passwörter'),
        'labels' => array(
            'name' => __('Passwörter'),
            'singular_name' => __('Passwort'),
            'menu_name' => __('Passwörter'),
            'parent_item' => __('Eltern Passwort'),
            'parent_item_colon' => __('Eltern Passwort:'),
            'all_items' => __('Alle Passwörter'),
            'view_item' => __('Passwort ansehen'),
            'add_new_item' => __('Neues Passwort'),
            'add_new' => __('Neues Passwort'),
            'edit_item' => __('Passwort bearbeiten'),
            'update_item' => __('Passwort aktualisieren'),
            'search_items' => __('Passwort suchen'),
            'not_found' => __('Nichts gefunden'),
            'not_found_in_trash' => __('Nichts gefunden im Papierkorb'),
            'archive_title' => __('Passwörter')
        ),
    ...
    $post_data['custom_fields'] = array(
        'key' => 'passwort_informationen',
        'title' => 'Passwort Informationen',
        'fields' => array(
            array(
                'key' => 'pv_id',
                'label' => 'Interne Nummer',
            ...
            array(
                'key' => 'pv_p_live_username',
                'label' => 'Benutzername',
                'name' => 'pv_p_live_username',
                'type' => 'text',
                'prefix' => '',
                'instructions' => '',
                'required' => 0,
            ...
            array(
                'key' => 'pv_p_live_passwort',
                'label' => 'Passwort',
                'name' => 'pv_p_live_passwort',
                'type' => 'text',
                'prefix' => '',
                'instructions' => '',
                'required' => 0,
            ...
            array(
                'key' => 'pv_p_entwicklung_accordion',
                'label' => 'Entwicklung',
                'type' => 'accordion',
                'required' => 0,
                'conditional_logic' => 0,
            ...
            array(
                'key' => 'pv_p_entwicklung_url',
                'label' => 'Domain',
                'name' => 'pv_p_entwicklung_url',
                'type' => 'url',
                'prefix' => '',
                'instructions' => '',
                'required' => 0,
            ...
            array(
                'key' => 'pv_p_entwicklung_username',
                'label' => 'Benutzername',
                'name' => 'pv_p_entwicklung_username',
                'type' => 'text',
                'prefix' => '',
                'instructions' => '',
                'required' => 0,
            ...
            array(
                'key' => 'pv_p_entwicklung_passwort',
                'label' => 'Passwort',
                'name' => 'pv_p_entwicklung_passwort',
                'type' => 'text',
                'prefix' => '',
                'instructions' => '',
                'required' => 0,
            ...
            array(
                'key' => 'pv_p_ftp_username',
                'label' => 'Benutzername',
                'name' => 'pv_p_ftp_username',
                'type' => 'text',
                'prefix' => '',
                'instructions' => '',
                'required' => 0,
            ...
            array(
                'key' => 'pv_p_ftp_passwort',
                'label' => 'Passwort',
                'name' => 'pv_p_ftp_passwort',
                'type' => 'text',
                'prefix' => '',
                'instructions' => '',
                'required' => 0,
            ...
            array(
                'key' => 'pv_p_hosting_hoster',
                'label' => 'Logindomain (Hoster)',
                'name' => 'pv_p_hosting_hoster',
                'type' => 'url',
                'prefix' => '',
                'instructions' => '',
                'required' => 0,
            ...
            array(
                'key' => 'pv_p_hosting_username',
                'label' => 'Benutzername',
                'name' => 'pv_p_hosting_username',
                'type' => 'text',
                'prefix' => '',
                'instructions' => '',
                'required' => 0,
            ...
            array(
                'key' => 'pv_p_hosting_passwort',
                'label' => 'Passwort',
                'name' => 'pv_p_hosting_passwort',
                'type' => 'text',
                'prefix' => '',
                'instructions' => '',
                'required' => 0,
...
add_filter('manage_edit-passwords_columns', 'pv_passwords_edit_admin_columns');
function pv_passwords_edit_admin_columns($columns)
{
    $columns = array(
        'cb' => '<input type="checkbox" />',
        'title' => __('Kunde'),
...
add_action('manage_passwords_posts_custom_column', 'pv_passwords_post_custom_columns');
function pv_passwords_post_custom_columns($column)
{
    global $post;
    switch ($column) {
        case 'shortname':
            echo get_field('pv_p_kuerzel');
            break;
        case 'domain':
            echo !empty(get_field('pv_p_live_url')) ? get_field('pv_p_live_url') : get_field('pv_p_entwicklung_url');
            break;
    }
}

add_filter('manage_edit-passwords_sortable_columns', 'pv_passwords_sortierbare_columns');
function pv_passwords_sortierbare_columns($columns)
{
    $columns['shortname'] = 'pv_p_kuerzel';
...
function pv_oder_by_title_cpt($query)
{
    if ($query->is_admin) {
        ...
        if ($post_type == 'passwords' || $post_type == 'kunden') {
